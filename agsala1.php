...
$query2 = "SELECT EV.ID, EV.TITULO, EV.INICIO, EV.HORA_INI, EV.FIM, EV.HORA_FIM, EV.COR, EV.USUARIO, USU.NOME || ' ' || USU.SOBRENOME AS NOME_USUARIO FROM IN_AGENDA EV, IN_USUARIOS USU WHERE EV.USUARIO = USU.ID AND SALA = 1";
    ...
    <div class="page-container row-fluid">
      ...
      <div class="page-content">
        ...
        <ul class="breadcrumb">
            ...
            <li>
              <a href="#" class="active">Sala de V&iacute;deo</a> 
            </li>
          </ul>
          <!-- BEGIN PAGE TITLE -->
                        ...
                        <div class="form-group col-md-2 col-sm-2 col-xs-2">
                          <div class="controls">
                            <div class='form-group'>
                              <input type="text" name="sala" style="text-align: center" value="1" class="form-control" readonly>                              
                            </div>
                          </div>
                        </div>                         
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 id="ADDModalLabel" class="semi-bold">Editar Evento</h4>                  
                </div>
                <div class="modal-body"> 
                  <div class="">
                    <div class="row" style="line-height:2;">
