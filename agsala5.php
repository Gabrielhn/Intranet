...
$query2 = "SELECT EV.ID, EV.TITULO, EV.INICIO, EV.HORA_INI, EV.FIM, EV.HORA_FIM, EV.COR, EV.USUARIO, USU.NOME || ' ' || USU.SOBRENOME AS NOME_USUARIO FROM IN_AGENDA EV, IN_USUARIOS USU WHERE EV.USUARIO = USU.ID AND SALA = 5";
    ...
    <div class="page-container row-fluid">
      ...
      <div class="page-content">
        ...
        <ul class="breadcrumb">
            ...
            <li>
              <a href="#" class="active">Audit&oacute;rio - antigo</a> 
            </li>
          </ul>
          <!-- BEGIN PAGE TITLE -->
                        ...
                        <div class="form-group col-md-2 col-sm-2 col-xs-2">
                          <div class="controls">
                            <div class='form-group'>
                              <input type="text" name="sala" style="text-align: center" value="5" class="form-control" readonly>                              
                            </div>
                          </div>
                        </div>                         
