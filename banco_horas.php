...
<html>
  <head>
    <title>Aniger - Banco de horas</title>
    ...
    <div class="page-container row-fluid">
      ...
      <div class="page-content">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="#.php" class="active">Banco de horas</a></li>
          </ul>
          <!-- BEGIN PAGE TITLE -->
          <div class="page-title"> <i class="fa fa-h-square fa-lg fa-fw" aria-hidden="true"></i>
              ...
              <div class="grid simple">
                <div class="grid-title no-border">
                  ...
                  <div class="form-group col-md-12 col-sm-12 col-xs-12">
                    <span class="help">Preencha abaixo as informa&ccedil;&otilde;es solicitadas para solicitar dispensa justificada.
                ...
                <div class="grid-body no-border">
                  ...
                  <div class="row">
                    <form method="POST" name="banco" action="data\clientes.S.php"> 
