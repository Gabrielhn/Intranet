            ...
            <div class="tiles dark-blue blend weather-widget ">
              ...
              <div class="tile-footer">
                <div class="pull-left">
                  ...
                  <i class="material-icons">label_outline</i><span class=" small-text-description">&nbsp;&nbsp;<span class="label">CTB</span>&nbsp;</span>
                </div>
                <div class="pull-right">
          ...
          <div class="col-md-3 col-sm-4 m-b-10">
            <div class="tiles dark-blue weather-widget ">
              ...
              <div class="tile-footer">
                <div class="pull-left">
                  <canvas id="" width="1" height="30"></canvas>
                  <i class="material-icons">label_outline</i><span class=" small-text-description">&nbsp;&nbsp;<span class="label">CMP</span>&nbsp;</span>
                </div>
                <div class="pull-right">
                  <canvas id="" width="1" height="28"></canvas>
