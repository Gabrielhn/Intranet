...
$query2 = "SELECT * FROM IN_LOCAIS WHERE LOCAL =':local'";
            ...
            <div class="col-md-12">
              <div class="grid simple ">
                ...
                <div class="grid-body no-border">
                  <h3><i class="fa fa-globe fa-1x"></i><span class="semi-bold">&nbsp; <?php echo $data['name'];?></span></h3>
