...
$query2 = "SELECT '(' || IT.MENU || ') ' || MN.NOME AS PAGINA, IT.TITULO, IT.ICONE, IT.ATRIBUTOS_1, IT.ATRIBUTOS_2, IT.LINK FROM IN_MENU_ITEM IT, IN_MENU MN WHERE IT.MENU = MN.ID ORDER BY 1";
...
<html>
  <head>
    <title>Aniger - Dados - Menus</title>
                  ...
                  <table class="table no-more-tables">
                    ...
                    <tbody>
                      ...
                      foreach ($result2 as $key => $value) {
                        echo '
                          <tr>                                                        
                            <td class="v-align-middle"><span class="muted">'.$result2[$key]['PAGINA'].'</span></td>
                            <td class="v-align-middle"><span class="muted">'.$result2[$key]['TITULO'].'</span></td>
