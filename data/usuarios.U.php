...
$query3="UPDATE IN_USUARIOS SET EMAIL = :email, SENHA = :senha, NOME = :nome, SETOR = :setor, CARGO = :cargo, RAMAL = :ramal, IM = :im, LOCAL = :local, ADMISSAO = :admissao, SOBRENOME = :sobrenome, TIPO_USUARIO = :tipo, ATIVO = :ativo WHERE ID = :idu";
