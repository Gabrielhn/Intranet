    ...
    <div class="page-container row-fluid">
      ...
      <div class="page-content">
        ...
        <ul class="breadcrumb">
          ...
          <li>
            <a href="#" class="active"> Editar vaga</a> 
          </li>
        </ul>
              ...
              <div class="grid simple ">                
                ...
                <div class="form-group col-md-12 col-sm-12 col-xs-12"></div>
                  <div class="form-group col-md-12 col-sm-12 col-xs-12">
                    <h3><i class="fa fa-bookmark fa-1x"></i><span class="semi-bold">&nbsp; Editar vaga</span></h3>
                  </div> 
                  <form method="post" name="vaga" action="vaga.U.php">

                    <div class="form-group col-md-5 col-sm-5 col-xs-5">
                      <div class="controls">
                        <input type="text" placeholder="Fun&ccedil;&atilde;o" value="<?php echo $result3[FUNCAO] ?>" class="form-control input" name="funcao" maxlength="60" required>
                      </div>
                    </div>                    
                    ...
                    <div class="form-group col-md-2 col-sm-2 col-xs-2">
                      <div class="controls">
                        <select id="source"  class="form-control input" value="<?php echo $result3[ATIVO] ?>" name="ativo" required>
                    ...
                    <div class="form-group col-md-1 col-sm-1 col-xs-1">
                      <div class="controls">
                        <input type="text"  value="<?php echo $result3[ID] ?>" class="form-control input" name="id" readonly required>
                      </div>
                    </div>              

                    <div class="form-group col-md-12 col-sm-12 col-xs-12">
                      <div class="controls">
                        <textarea id="descricao" placeholder="Descri&ccedil;&atilde;o" class="form-control input" rows="5" name="descricao" maxlength="600"><?php echo $result3[DESCRICAO] ?></textarea>
                      </div>
                    </div>

                    <div class="form-group col-md-12 col-sm-12 col-xs-12">
                      <div class="controls">
                        <textarea id="requisitos" placeholder="Requisitos" class="form-control input" rows="5" name="requisitos" maxlength="600"><?php echo $result3[REQUISITOS] ?></textarea>
                      </div>
                    </div>
