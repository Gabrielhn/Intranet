...
<html>
  <head>
    <title>Aniger - Fornecedores</title>
    ...
    <div class="page-container row-fluid">
      ...
      <div class="page-content">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="#.php" class="active">Fornecedores</a></li>
          </ul>
          <!-- BEGIN PAGE TITLE -->
          <div class="page-title"> <i class="fa fa-group fa-lg fa-fw" aria-hidden="true"></i>
            <h3>Fornecedores</h3>
          </div>
          <!-- END PAGE TITLE -->
          <!-- CONTEUDO -->
                    ...
                    <form method="POST" name="fornecedores" action="assets\php\fornecedor_mail.php" target="place">
                      <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-3" >
                          <div class="controls">
                            <input type="text" placeholder="N&ordm;/Comp." class="form-control input" maxlength="15" name="nro" required>
                          </div>
                        </div>
                        ...
                        <div class="form-group col-md-12 col-sm-12 col-xs-12">
                          <div class="controls">
                            <input type="text" placeholder="Tipo de Material/Servi&ccedil;o" class="form-control input" name="tpmatserv" required>
                          </div>
                        </div>
