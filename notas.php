            ...
            <ul class="nav quick-section ">
              <li class="quicklinks">
                ...
                <ul class="dropdown-menu  pull-right" role="menu" aria-labelledby="user-options">
                  <li class="">
                    <a href="perfil.php" title="Acesse seu perfil"><i class="fa fa-male fa-fw"></i>&nbsp;&nbsp;Meu perfil</a>a href="perfil.php" title="Acesse seu perfil"> Meu perfil</a>
                  </li>
                  <!-- <li class="disabled">
    ...
    <div class="page-container row-fluid">
      ...
      <div class="page-content">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="#.php" class="active">Notas</a></li>
          </ul>
          <!-- BEGIN PAGE TITLE -->
          <div class="page-title"> <i class="fa fa-files-o fa-lg fa-fw" aria-hidden="true"></i>
            <h3>Notas </h3>
          </div>
          <!-- END PAGE TITLE -->
          <!-- CONTEÚDO -->
