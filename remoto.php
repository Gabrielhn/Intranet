...
<html>
  <head>
    <title>Aniger - Atendimento Remoto</title>
    ...
    <div class="page-container row-fluid">
        ...
        <div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper">
          ...
          <!-- BEGIN SIDEBAR MENU -->
            <?php
               ...
               exibe_menu_lateral("chamados.php");
            ?>
          <!-- END SIDEBAR MENU -->
        </div>
      </div>
      ...
      <div class="page-content">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="#" class="active">Atendimento Remoto</a> </li>
          </ul>
          <!-- BEGIN PAGE TITLE -->
          <div class="page-title"> 
            <i class="fa fa-desktop" title="Atendimento remoto"></i>
            <h3>Atendimento</h3>
          </div>
          <!-- END PAGE TITLE -->
          ...
          <div class=" container">
            ...
            <!-- <div class="content">
              <div class"row">
                <div class="col-md-4 col-md-offset-4 user-description-box" style="text-align:center;">
