...
$query2 = "SELECT SE.SIGLA, SE.NOME,'(' || SE.GESTOR || ') ' || USR.NOME AS GESTOR FROM IN_SETORES SE, IN_USUARIOS USR WHERE SE.GESTOR = USR.ID ORDER BY 2";
                  ...
                  <table class="table no-more-tables">
                    <thead>
                      <tr>
                        ...
                        <th style="width:20%">Sigla (PK)</th>
                        <th style="width:35%">Nome</th>
                        <th style="width:35%">Gestor</th>
                          ...
                          <tr>
                            <td class="v-align-middle">
                              <div class="checkbox check-success">
                                <input id="checkbox'.$rr.'" type="checkbox">
